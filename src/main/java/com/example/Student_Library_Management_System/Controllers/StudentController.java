...
public class StudentController {
    ...
    @PutMapping("update_MobNumber")
    public String updateMobNumber(@RequestBody StudentUpdateMobRequestDTo studentUpdateMobRequestDTo){

        return studentService.updateMobNumber(studentUpdateMobRequestDTo);
    }
